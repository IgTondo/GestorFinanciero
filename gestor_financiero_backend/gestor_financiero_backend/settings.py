...
SECRET_KEY = 'django-insecure-njvof%)@&skk+lfhcx)b=lnh58@^o%@1r@sel$=vb=e7+g1r32'
...
ROOT_URLCONF = 'gestor_financiero_backend.urls'
...
WSGI_APPLICATION = 'gestor_financiero_backend.wsgi.application'
